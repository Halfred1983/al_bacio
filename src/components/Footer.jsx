  ...
  return (
    <footer className="bg-cacao-900 text-cream-100 relative pt-16 pb-12 border-t border-cacao-800 text-center">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        ...
        {/* Contact & Social */}
        <div className="space-y-3 text-xs text-cream-300 font-light mb-8">
          <p className="flex items-center justify-center gap-1.5">
            <MapPin className="w-3.5 h-3.5 text-terracotta-400" />
            <span>{t.footer.location}</span>
          </p>

          <div className="flex flex-wrap items-center justify-center gap-x-5 gap-y-2 pt-1 text-xs">
            <a
              href="tel:+34611985121"
              className="inline-flex items-center gap-1.5 text-cream-200 hover:text-white transition-colors"
            >
              <Phone className="w-3.5 h-3.5 text-caramel-400" />
              <span className="font-mono font-medium">+34 611 98 51 21</span>
            </a>
            <span className="text-cacao-700 hidden sm:inline">·</span>
            <a
              href="https://wa.me/34611985121"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-1.5 text-[#25D366] hover:brightness-125 transition-all font-semibold"
            >
            ...
            <a
              ...
              className="inline-flex items-center gap-1.5 text-cream-200 hover:text-white transition-colors"
            >
              <Mail className="w-3.5 h-3.5 text-caramel-400" />
              <span>naturalmentegelato.lab@gmail.com</span>
            </a>
          </div>
